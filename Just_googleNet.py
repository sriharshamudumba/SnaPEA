...
# Function to train and evaluate GoogLeNet
def train_and_evaluate_googlenet():
    ...
    print(f"GoogLeNet - Accuracy: {accuracy:.4f}, Inference Time: {inference_time:.2f}s")
    return accuracy, inference_time

if __name__ == "__main__":
    train_and_evaluate_googlenet()
